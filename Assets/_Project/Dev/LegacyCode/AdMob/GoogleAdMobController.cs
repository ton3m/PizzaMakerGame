...
namespace PizzaMaker.LegacyCode.AdMob
{
    public class GoogleAdMobController : MonoBehaviour
    {
        private static GoogleAdMobController instance;
        public static GoogleAdMobController Instance { get => instance; }
        ...
        public UnityEvent OnUserCompleteLevelEvent;
            ...
            InterstitialAd.Load(adUnitId, CreateAdRequest(),
                (InterstitialAd ad, LoadAdError loadError) =>
                {
                    ...
                    ad.OnAdFullScreenContentClosed += () =>
                    {
                        ...
                        OnUserCompleteLevelEvent.Invoke();
                        OnAdClosedEvent.Invoke();
                    };
